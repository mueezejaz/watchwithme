...
function RoomLayoutInner({
  ...
  return (
    <div className="flex flex-col bg-background app-container">
      ...
      <div className="flex min-h-0 flex-1 flex-col overflow-hidden md:flex-row">
        ...
        >
          ...
          <div className={`relative min-w-0 min-h-0 ${isFullscreen ? "flex-1 p-0" : "flex-shrink-0 max-h-[55vh] p-4 md:flex-1 md:max-h-none md:p-6"} flex items-center justify-center overflow-hidden`}>
            {videoId ? (
              <ReactPlayerWrapper
